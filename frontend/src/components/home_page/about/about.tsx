...
const About: React.FC = () => {
  return (
    <>
      {/* Intro Section - White */}
      <section className="about-intro-wrapper bg-white">
        <div className="container-kinetic">
          <div className="about-intro-section">
            ...
            <div className="about-intro-visuals">
              <div className="about-carousel-col kinetic-border-shadow">
                <Carousel images={[MentorPics.fifth, MentorPics.third, MentorPics.seventh, MentorPics.ninth, MentorPics.forth, MentorPics.second, MentorPics.sixth, MentorPics.first]} />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Pillars Section - Navy */}
      <section className="about-pillars-wrapper bg-navy">
        <div className="container-kinetic">
